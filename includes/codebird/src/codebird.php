...
//To support PHP 5.2.x we are removing Namespaces
//namespace WP_Notes_Widget_Codebird;
...
/**
 * A Twitter library in PHP.
 * We rename the Codebird class to avoid conflicts with other plugins which may also be using Codebird. 
 * As stated above, we can't use namespaces.
 *
 * @package codebird
 * @subpackage codebird-php
 */
class WP_Notes_Widget_Codebird
{
    /**
