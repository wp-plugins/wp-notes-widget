<?php
		...
		<div class="wp-notes-widget-admin-container">
				...
				<p>
					<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title', 'wp-notes-widget' ); ?>:</label>
				...
				<p>
					...
					<label for="<?php echo $this->get_field_id('use_custom_style'); ?>"><?php _e('I will use my own CSS styles for WP Notes', 'wp-notes-widget'); ?></label>
